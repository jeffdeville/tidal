---
name: investigate
description: Systematically diagnose failures in Colony directives and tasks using observability MCP tools
---

# Investigation Skill

Systematic failure diagnosis for Colony directives and tasks. Triggered by an MCP alert notification or a manual request to investigate a directive/task failure.

**Input**: An alert struct, a directive ID, or a task ID to investigate.
