...
**Task**: Use the `architect-elixir` agent to conduct a thorough architecture review following these steps:
...
**Subagent**: Use the `architect-elixir` agent with the Task tool to perform the review.
