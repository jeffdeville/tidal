...
Assemble all tasks into the final DAG and submit using the MCP tool `create_subtasks`:
...
Arguments:
  ...
  decomposition_rationale:
    strategy: "Expert panel with N experts. [How tasks integrate and why they were split this way]"
