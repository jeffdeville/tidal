...
sync_pack: universal
sync_source: packs/universal/mental-models/SKILL.md
sync_version: d3fefcef
---

# Mental Models for Software Engineering

These models share a common purpose: reducing **cognitive load** — the mental effort required to understand and change a system. The cognitive-load skill covers this foundational principle in depth. The models below are specific lenses that operationalize it. Use multiple lenses for important decisions.
